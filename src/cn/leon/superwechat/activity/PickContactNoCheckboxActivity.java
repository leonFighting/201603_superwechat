...
public class PickContactNoCheckboxActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.leon.superwechat.R.layout.activity_pick_contact_no_checkbox);
		...
		getContactList();
		// 设置adapter
		contactAdapter = new ContactAdapter(this, cn.leon.superwechat.R.layout.row_contact, contactList);
