...
import cn.leon.superwechat.task.DownloadImageTask;
...
public class AlertDialog extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.leon.superwechat.R.layout.alert_dialog);
		mTextView = (TextView) findViewById(cn.leon.superwechat.R.id.title);
		mButton = (Button) findViewById(cn.leon.superwechat.R.id.btn_cancel);
		imageView = (ImageView) findViewById(cn.leon.superwechat.R.id.image);
		editText = (EditText) findViewById(cn.leon.superwechat.R.id.edit);
		//提示内容
		...
		if(msg != null)
		    ((TextView)findViewById(cn.leon.superwechat.R.id.alert_message)).setText(msg);
		if(title != null)
		...
		if(path != null){
		    ...
		    ((TextView)findViewById(cn.leon.superwechat.R.id.alert_message)).setVisibility(View.GONE);
