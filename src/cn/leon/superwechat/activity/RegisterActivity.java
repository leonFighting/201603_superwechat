...
public class RegisterActivity extends BaseActivity {
	...
	public void register(View view) {
		...
		if (TextUtils.isEmpty(username)) {
			Toast.makeText(this, getResources().getString(cn.leon.superwechat.R.string.User_name_cannot_be_empty), Toast.LENGTH_SHORT).show();
			userNameEditText.requestFocus();
			return;
		} else if (TextUtils.isEmpty(pwd)) {
			Toast.makeText(this, getResources().getString(cn.leon.superwechat.R.string.Password_cannot_be_empty), Toast.LENGTH_SHORT).show();
			passwordEditText.requestFocus();
			return;
		} else if (TextUtils.isEmpty(confirm_pwd)) {
			Toast.makeText(this, getResources().getString(cn.leon.superwechat.R.string.Confirm_password_cannot_be_empty), Toast.LENGTH_SHORT).show();
			confirmPwdEditText.requestFocus();
			return;
		} else if (!pwd.equals(confirm_pwd)) {
			Toast.makeText(this, getResources().getString(cn.leon.superwechat.R.string.Two_input_password), Toast.LENGTH_SHORT).show();
			return;
		}
					...
					try {
						...
						runOnUiThread(new Runnable() {
							public void run() {
								...
								Toast.makeText(getApplicationContext(), getResources().getString(cn.leon.superwechat.R.string.Registered_successfully), 0).show();
								finish();
							}
						});
