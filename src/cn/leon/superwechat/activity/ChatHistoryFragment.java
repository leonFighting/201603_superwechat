...
public class ChatHistoryFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(cn.leon.superwechat.R.layout.fragment_conversation_history, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		errorText = (TextView) errorItem.findViewById(cn.leon.superwechat.R.id.tv_connect_errormsg);
		// contact list
		...
		final String st = getResources().getString(cn.leon.superwechat.R.string.Cant_chat_with_yourself);
		listView.setOnItemClickListener(new OnItemClickListener() {

			@Override
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				EMContact emContact = adapter.getItem(position);
				if (adapter.getItem(position).getUsername().equals(SuperWeChat.getInstance().getUserName()))
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		getActivity().getMenuInflater().inflate(cn.leon.superwechat.R.menu.delete_message, menu);
		// }
	}

	@Override
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == cn.leon.superwechat.R.id.delete_message) {
	 ...
	 */
	public void refresh() {
		adapter = new ChatHistoryAdapter(getActivity(), cn.leon.superwechat.R.layout.row_chat_history, loadUsersWithRecentChat());
		listView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
	}
