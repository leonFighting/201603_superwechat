...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(cn.leon.superwechat.R.drawable.chatfrom_voice_playing);
		} else {
			voiceIconView.setImageResource(cn.leon.superwechat.R.drawable.chatto_voice_playing);
		}
		// stop play voice
		if (mediaPlayer != null) {
			mediaPlayer.stop();
	...
	public void onClick(View v) {
		String st = activity.getResources().getString(cn.leon.superwechat.R.string.Is_download_voice_click_later);
		if (isPlaying) {
